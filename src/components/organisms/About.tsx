  ...
  return (
    <article className={styles.article}>
      ...
      <div className={styles.body}>
        <p>BreathNoteは、フロントエンドの話題や備忘録をアウトプットしているブログです。</p>
        <p>
          当サイトに掲載されているコンテンツは自由にご利用いただけますが、ご利用の際に生じた如何なる不具合も当サイトは一切責任を負いません。自己責任でご利用ください。なお、プロフィールアイコンなどの当サイトオリジナル素材は、ダウンロード等を固く禁じています。ご了承ください。
        </p>
        <p>管理者へのお問い合わせやエントリーの訂正・削除希望などは、Twitter等からご連絡ください。</p>
