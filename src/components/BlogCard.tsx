...
const BlogCard: FC<Props> = ({ post }) => {
  return (
    <>
      <article className="p-3 md:p-4 lg:p-5 mb-5 md:mb-7 lg:mb-8 xl:mb-9 rounded-lg border-light dark:border-dark shadow-neumo hover:shadow-none dark:shadow-neumo-dark dark:hover:shadow-none relative transition-shadow-border">
